  ...
  return (
    <div style={{ background: '#ffffff' }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-sm leading-relaxed" style={{ color: '#374151' }}>
          <section>
            <h2 style={{ fontFamily: 'var(--font-headline)', color: '#0f172a', fontSize: '1.3rem', letterSpacing: '0.06em', marginBottom: '0.75rem' }}>
              1. VERANTWORTLICHER
            </h2>
            <p>
            ...
            <ul className="space-y-2 list-none">
              {[
                ...
                <li key={zweck} className="flex gap-3">
                  <span style={{ color: 'rgba(29,78,216,0.4)' }}>▸</span>
                  <span><strong style={{ color: '#0f172a' }}>{zweck}:</strong> {basis}</span>
                </li>
              ))}
            </ul>
          </section>
            ...
            <ul className="space-y-1 list-none">
              {['Name', 'Telefonnummer', 'Anliegen (Art des Zahnproblems)', 'Bevorzugte Rückrufzeit (optional)'].map(d => (
                <li key={d} className="flex gap-3">
                  <span style={{ color: 'rgba(29,78,216,0.4)' }}>·</span>{d}
                </li>
              ))}
            </ul>
            <p className="mt-3">
              Wir speichern <strong style={{ color: '#0f172a' }}>keine Gesundheitsdaten</strong> ohne gesonderte Einwilligung. Das Anliegen (z.B. „akute Schmerzen") wird nicht als Patientenakte gespeichert.
            </p>
          </section>
            ...
            <ul className="space-y-3 list-none">
              {[
                ...
                <li key={name} className="flex gap-3">
                  <span style={{ color: 'rgba(29,78,216,0.4)' }}>▸</span>
                  <span><strong style={{ color: '#0f172a' }}>{name}</strong> — {zweck} ({server})</span>
                </li>
              ))}
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Diese Website nutzt <strong style={{ color: '#0f172a' }}>Plausible Analytics</strong> — eine cookielose, DSGVO-konforme Alternative zu Google Analytics. Es werden keine personenbezogenen Daten übertragen, kein Cookie gesetzt, kein Geräteprofil erstellt. Alle Daten werden auf EU-Servern in Deutschland gespeichert.
            </p>
          </section>
