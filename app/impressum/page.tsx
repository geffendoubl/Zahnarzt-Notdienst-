  ...
  return (
    <div style={{ background: '#080810' }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ color: 'rgba(245,240,232,0.7)' }}>
          <section>
            <h2 style={{ fontFamily: 'var(--font-headline)', color: '#f5f0e8', fontSize: '1.2rem', letterSpacing: '0.06em', marginBottom: '0.75rem' }}>
              ANGABEN GEMÄß § 5 ECG
            </h2>
            <p>
              <strong style={{ color: '#f5f0e8' }}>Zahnarzt Notdienst (Privat)</strong><br />
              Darwingasse 37<br />
              1020 Wien<br />
              Österreich
            </p>
          ...
          <section>
            ...
            <p>
              ...
              Zuständige Kammer: <a href="https://www.zak.or.at" target="_blank" rel="noopener noreferrer" style={{ color: '#1aedff', textDecoration: 'none' }}>Österreichische Zahnärztekammer, Landeszahnärztekammer Wien</a><br />
          ...
          <section>
            ...
            <p>
              ...
              <a href="https://www.zak.or.at" target="_blank" rel="noopener noreferrer" style={{ color: '#1aedff', textDecoration: 'none' }}>www.zak.or.at</a>
            </p>
          </section>
