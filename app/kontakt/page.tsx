    ...
    <div style={{ background: '#0d1b2e' }}>
      <section className="py-16 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto relative">
          ...
          >
            DIREKT<br />
            <span style={{ color: '#4b8ef5' }}>ERREICHBAR.</span>
          </h1>
        </div>
      </section>
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <p className="text-sm leading-relaxed" style={{ color: 'rgba(238,243,255,0.75)' }}>
                ...
                <br />
                <span style={{ color: 'rgba(238,243,255,0.4)', fontFamily: 'var(--font-mono)', fontSize: '0.75rem' }}>
              ...
              <a
                ...
                style={{ color: '#4b8ef5', textDecoration: 'none', fontFamily: 'var(--font-mono)', fontSize: '0.72rem', letterSpacing: '0.1em' }}
              >
                IN MAPS ÖFFNEN →
              </a>
            </div>
          ...
          {submitted ? (
            ...
            >
              <div className="text-center">
                ...
                <p className="text-sm mt-3" style={{ color: 'rgba(238,243,255,0.6)' }}>
            ...
            <form onSubmit={handleSubmit} className="card-dark rounded-sm p-6 flex flex-col gap-4">
              <h2 style={{ fontFamily: 'var(--font-headline)', fontSize: '1.3rem', letterSpacing: '0.08em', color: '#eef3ff' }}>
                NACHRICHT SENDEN
              </h2>
              ...
              <button
                ...
                style={{ background: '#e04747', color: '#fff', fontFamily: 'var(--font-headline)', fontSize: '1rem', letterSpacing: '0.08em' }}
              >
