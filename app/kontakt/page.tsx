    ...
    <div style={{ background: '#080810' }}>
      <section className="py-16 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto relative">
          ...
          >
            DIREKT<br />
            <span style={{ color: '#1aedff' }}>ERREICHBAR.</span>
          </h1>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 pb-20">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <div className="text-xs mb-3 tracking-widest" style={{ fontFamily: 'var(--font-mono)', color: '#6b6b8a' }}>ADRESSE</div>
              <p className="text-sm leading-relaxed" style={{ color: 'rgba(245,240,232,0.75)' }}>
                Darwingasse 37<br />1020 Wien (Leopoldstadt)<br />
                <br />
                <span style={{ color: 'rgba(245,240,232,0.4)', fontFamily: 'var(--font-mono)', fontSize: '0.75rem' }}>
              ...
              <a
                ...
                style={{ color: '#1aedff', textDecoration: 'none', fontFamily: 'var(--font-mono)', fontSize: '0.72rem', letterSpacing: '0.1em' }}
              >
                IN MAPS ÖFFNEN →
              </a>
            </div>
          ...
          {submitted ? (
            ...
            >
              <div className="text-center">
                <div style={{ fontFamily: 'var(--font-headline)', fontSize: '2rem', color: '#22c55e', letterSpacing: '0.05em' }}>
                  NACHRICHT GESENDET
                </div>
                <p className="text-sm mt-3" style={{ color: 'rgba(245,240,232,0.6)' }}>
            ...
            <form onSubmit={handleSubmit} className="card-dark rounded-sm p-6 flex flex-col gap-4">
              <h2 style={{ fontFamily: 'var(--font-headline)', fontSize: '1.3rem', letterSpacing: '0.08em', color: '#f5f0e8' }}>
                NACHRICHT SENDEN
              </h2>
              ...
              <button
                ...
                style={{ background: '#ff3e2f', color: '#fff', fontFamily: 'var(--font-headline)', fontSize: '1rem', letterSpacing: '0.08em' }}
              >
