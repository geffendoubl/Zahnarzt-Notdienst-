        ...
        <div className="max-w-6xl mx-auto">
            ...
            {services.map((s) => (
              ...
              >
                <div
                  ...
                  style={{ color: 'rgba(26,237,255,0.6)' }}
                >
                  {s.icon}
                </div>
                <h3
          ...
          <div className="mt-8 text-center">
            <Link
              ...
              style={{ fontFamily: 'var(--font-mono)', color: '#1aedff', textDecoration: 'none', fontSize: '0.75rem', letterSpacing: '0.1em' }}
            >
              ALLE LEISTUNGEN →
            </Link>
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto relative z-10">
            ...
            {[
              ...
              <div key={num} className="flex gap-4">
                <div
                  ...
                  style={{ fontFamily: 'var(--font-headline)', color: 'rgba(26,237,255,0.3)' }}
                >
                  {num}
                </div>
                <div>
                  <h3
                    className="mb-1.5"
                    style={{ fontFamily: 'var(--font-headline)', fontSize: '1.15rem', letterSpacing: '0.05em', color: '#f5f0e8' }}
                  >
                    {title.toUpperCase()}
                  </h3>
          ...
          <div
            ...
            style={{ background: 'rgba(26,237,255,0.06)', border: '1px solid rgba(26,237,255,0.2)' }}
          >
            <span style={{ color: '#1aedff', fontSize: '1.2rem' }}>ℹ</span>
            <p className="text-sm leading-relaxed" style={{ color: 'rgba(245,240,232,0.7)' }}>
              ...
              <Link href="/leistungen#privat" style={{ color: '#1aedff', textDecoration: 'none' }}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
            <div className="flex flex-col gap-4">
              <a
                href={PHONE_HREF}
                className="flex items-center gap-4 p-5 rounded-sm no-underline transition-all hover:scale-[1.02] active:scale-[0.98] animate-pulse-ring"
                style={{ background: '#ff3e2f', color: '#fff', textDecoration: 'none', boxShadow: '0 4px 30px rgba(255,62,47,0.3)' }}
              >
              ...
              <a
                ...
                style={{ background: 'rgba(26,237,255,0.1)', border: '1px solid rgba(26,237,255,0.35)', color: '#1aedff', textDecoration: 'none' }}
              >
                <svg width="28" height="28" viewBox="0 0 24 24" fill="#1aedff" aria-hidden="true">
            ...
            >
              <h3
                className="mb-4"
                style={{ fontFamily: 'var(--font-headline)', fontSize: '1.3rem', letterSpacing: '0.08em', color: '#f5f0e8' }}
              >
                SCHNELLNACHRICHT
              </h3>
              <p className="text-xs mb-5" style={{ fontFamily: 'var(--font-mono)', color: 'rgba(245,240,232,0.4)' }}>
    ...
    <form action="/api/contact" method="POST" className="flex flex-col gap-3">
      ...
      <label className="flex items-start gap-2.5 cursor-pointer mt-1">
        ...
        <span className="text-xs leading-relaxed" style={{ color: 'rgba(245,240,232,0.5)' }}>
          Ich stimme der{' '}
          <a href="/datenschutz" style={{ color: '#1aedff', textDecoration: 'none' }}>
