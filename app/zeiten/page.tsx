    ...
    <div style={{ background: '#080810' }}>
      ...
      <section className="py-16 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto relative">
          ...
          >
            TÄGLICH<br />
            <span style={{ color: '#1aedff' }}>FÜR SIE DA.</span>
          </h1>
          ...
          {today !== null && (
            <div
              ...
              style={{
                background: open ? 'rgba(34,197,94,0.08)' : 'rgba(255,62,47,0.08)',
                border: `1px solid ${open ? 'rgba(34,197,94,0.3)' : 'rgba(255,62,47,0.3)'}`,
              }}
            >
              <span
                className="animate-dot-pulse text-sm"
                style={{ color: open ? '#22c55e' : '#ff3e2f' }}
              >
                ●
              </span>
              <span
      ...
      <section className="px-4 sm:px-6 pb-16">
        <div className="max-w-2xl mx-auto">
            ...
            {rows.map(({ day, name, note }, i) => {
              ...
              return (
                <div
                  ...
                  style={{
                    borderBottom: i < rows.length - 1 ? '1px solid rgba(26,237,255,0.08)' : undefined,
                    background: isToday ? 'rgba(26,237,255,0.06)' : 'transparent',
                  }}
                >
                  <div className="flex items-center gap-3">
                    {isToday && (
                      <span
                        ...
                        style={{ fontSize: '0.5rem', color: open ? '#22c55e' : '#ff3e2f' }}
                      >
                        ●
                      </span>
                    )}
                    <span
                      style={{
                        ...
                        color: isToday ? '#1aedff' : 'rgba(245,240,232,0.75)',
                    ...
                    {note && (
                      <span
                        ...
                        style={{
                          ...
                          color: '#ff3e2f',
                          border: '1px solid rgba(255,62,47,0.25)',
                        }}
                      >
                        {note}
                      </span>
                  ...
                  <span
                    style={{
                      fontFamily: 'var(--font-mono)',
                      fontSize: '0.85rem',
                      color: isSat ? '#ff3e2f' : isToday ? '#f5f0e8' : 'rgba(245,240,232,0.55)',
          ...
          <div
            ...
            style={{
              background: 'rgba(255,62,47,0.07)',
              border: '1px solid rgba(255,62,47,0.22)',
            }}
          >
            <div
              className="text-xs font-bold mb-1.5"
              style={{ fontFamily: 'var(--font-headline)', color: '#ff3e2f', letterSpacing: '0.12em' }}
            >
              SAMSTAG NOTDIENST
            </div>
            <p className="text-sm" style={{ color: 'rgba(245,240,232,0.65)' }}>
              Samstags sind wir ausschließlich von <strong style={{ color: '#ff3e2f' }}>20:00 bis 22:30 Uhr</strong> für echte Notfälle geöffnet.
      ...
      {/* Location */}
      <section className="py-12 px-4 sm:px-6" style={{ background: '#1c1c2e' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex flex-col gap-4">
              ...
              <div className="p-4 rounded-sm card-dark">
                ...
                <ul className="flex flex-col gap-1.5 text-sm" style={{ color: 'rgba(245,240,232,0.7)' }}>
              ...
              <a
                ...
                style={{ background: '#ff3e2f', color: '#fff', textDecoration: 'none', fontFamily: 'var(--font-headline)', fontSize: '1.2rem', letterSpacing: '0.06em' }}
              >
                JETZT ANRUFEN
              </a>
            </div>
            <div
              ...
              style={{ background: '#1c1c2e', border: '1px solid rgba(26,237,255,0.15)', minHeight: 220 }}
            >
              <div className="text-center p-6">
                <p className="text-sm mb-3" style={{ color: 'rgba(245,240,232,0.4)', fontFamily: 'var(--font-mono)' }}>
                ...
                <a
                  ...
                  style={{ background: 'rgba(26,237,255,0.1)', color: '#1aedff', textDecoration: 'none', border: '1px solid rgba(26,237,255,0.3)', fontFamily: 'var(--font-mono)', fontSize: '0.75rem', letterSpacing: '0.1em' }}
                >
