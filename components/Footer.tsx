      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          <div
            ...
            style={{ fontFamily: 'var(--font-headline)', letterSpacing: '0.08em', color: '#0f172a' }}
          >
            ZAHNARZT{' '}
            <span style={{ color: '#1d4ed8' }}>NOTDIENST</span>
          </div>
          <p
            className="text-xs mb-1"
            style={{ fontFamily: 'var(--font-mono)', color: '#9ca3af', letterSpacing: '0.1em' }}
          >
            <strong style={{ color: '#0f172a' }}>PRIVAT</strong> ORDINATION
          </p>
          <p className="text-sm mt-3" style={{ color: '#6b7280', lineHeight: 1.6 }}>
        ...
        <div>
          ...
          >
            ...
            <span>Sa</span><span style={{ color: '#dc2626' }}>20:00–22:30*</span>
            <span>So</span><span>10:00–21:00</span>
          </div>
          <p className="text-xs mt-2" style={{ color: '#9ca3af', fontFamily: 'var(--font-mono)' }}>
            *Samstag: Notdienst
          </p>
        </div>
      </div>
