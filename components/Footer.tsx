  ...
  return (
    <footer
      ...
      style={{
        ...
        borderTop: '1px solid rgba(75, 142, 245, 0.08)',
      }}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div>
          <div
            ...
            style={{ fontFamily: 'var(--font-headline)', letterSpacing: '0.08em', color: '#eef3ff' }}
          >
            ZAHNARZT{' '}
            <span style={{ color: '#4b8ef5' }}>NOTDIENST</span>
          </div>
          <p
            className="text-xs mb-1"
            style={{ fontFamily: 'var(--font-mono)', color: '#6b6b8a', letterSpacing: '0.1em' }}
          >
            <strong style={{ color: '#eef3ff' }}>PRIVAT</strong> ORDINATION
          </p>
          <p className="text-sm mt-3" style={{ color: 'rgba(238,243,255,0.5)', lineHeight: 1.6 }}>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2.5 text-sm">
            <a
              ...
              style={{ color: '#eef3ff', textDecoration: 'none' }}
            >
            ...
            <a
              ...
              style={{ color: 'rgba(238,243,255,0.5)', textDecoration: 'none' }}
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div>
          ...
          <div
            ...
            style={{ fontFamily: 'var(--font-mono)', color: 'rgba(238,243,255,0.55)' }}
          >
            <span>Mo–Do</span><span>10:00–21:00</span>
            <span>Fr</span><span>10:00–19:00</span>
            <span>Sa</span><span style={{ color: '#e04747' }}>20:00–22:30*</span>
            <span>So</span><span>10:00–21:00</span>
          </div>
          <p className="text-xs mt-2" style={{ color: 'rgba(238,243,255,0.3)', fontFamily: 'var(--font-mono)' }}>
            *Samstag: Notdienst
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
        <p
          className="text-xs"
          style={{ fontFamily: 'var(--font-mono)', color: 'rgba(238,243,255,0.25)' }}
        >
