  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between gap-4">
        ...
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2.5 shrink-0 no-underline" style={{ textDecoration: 'none' }}>
          ...
          <div className="px-4 py-4 flex flex-col gap-0.5">
            {links.map(({ href, label }) => (
              <Link
                key={href}
                href={href}
                className="py-3 px-3 rounded no-underline transition-colors"
                style={{
                  fontFamily: 'var(--font-body)',
                  fontSize: '1rem',
